...
package com.pragmatickm.contact.view.book;
...
@WebServlet("/contact/view/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
      ...
      "/contact/view/apidocs/com.pragmatickm.contact.view/com" + Objects.toString(req.getPathInfo(), ""),
